...
this.setVisible(true);
 ...
 public ArrayList<Customers> customerList(){
	 ...
	 try {
		...
		while(rs.next()){
			Customers customers = new Customers(rs.getInt("id"),rs.getString("first_name"),rs.getString("last_name"),rs.getString("phone"),rs.getString("address"),rs.getString("city"),rs.getString("state"),rs.getString("postalCode"));
 ...
 public void show_customers() {
	 ArrayList<Customers> details = customerList();
	 DefaultTableModel model = (DefaultTableModel)jTable_details.getModel();
	 Object[] row = new Object[8];
	 for(int i =0;i<details.size();i++) {
		 row[0] = details.get(i).getId();
		 row[1] = details.get(i).getFirstName();
		 row[2] = details.get(i).getLastNAme();
		 row[3] = details.get(i).getPhone();
		 row[4] = details.get(i).getAddress();
		 row[5] = details.get(i).getCity();
		 row[6] = details.get(i).getState();
		 row[7] = details.get(i).getPostalCode();
		 model.addRow(row);
	 }
 }
 ...
 refreshTable();
 show_customers();
 JOptionPane.showMessageDialog(this, "Customer Successfully Add!");
 }
 catch(Exception e6)
 ...
 refreshTable();
 show_customers();
 JOptionPane.showMessageDialog(this, "Customer Successfully Delete!");
 }
 catch(Exception e7)
 ...
 refreshTable();
 show_customers();
 JOptionPane.showMessageDialog(this, "Customer Successfully Update!");
 }
 catch(Exception e8)
 ...
 refreshTable();
 show_customers();
 JOptionPane.showMessageDialog(this, "Customers Successfully Clear!");
 }
 catch(Exception e9)
 ...
 public static void main(String []args)
 {
	 ...
	 demo.show_customers();
     demo.getContentPane().setBackground(Color.LIGHT_GRAY);
 }
 }